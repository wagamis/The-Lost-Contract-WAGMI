...
contract WAGMI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0000000000000000000000000000000000000001); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0000000000000000000000000000000000000001); // BuyBack Address
